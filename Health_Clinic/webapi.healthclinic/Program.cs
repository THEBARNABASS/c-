...
.AddJwtBearer("JwtBearer", options =>
{
	options.TokenValidationParameters = new TokenValidationParameters
	{
		...
		IssuerSigningKey = new SymmetricSecurityKey(System.Text.Encoding.UTF8.GetBytes("senai-health-clinic-chave-autenticacao-webapi-dev")),
...
builder.Services.AddSwaggerGen(options =>
{
	...
	options.SwaggerDoc("v1", new OpenApiInfo
	{
		...
		Description = "API para gerenciamento de Clínicas (backend API)",

		Contact = new OpenApiContact
		{
			Name = "Cauã S. Francelino - DevManhã",
			Url = new Uri("https://github.com/THEBARNABASS/c-/tree/main/HealthClinic")
		},
	});
